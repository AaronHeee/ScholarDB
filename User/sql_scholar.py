...
def participation_list(uno):
    ...
    cursor.execute("SELECT DISTINCT TASK.TNO,TITLE,SUBMIT_TIME,PAYMENT,STATUS FROM PARTICIPATION_TASK,TASK,FILE WHERE UNO = %d AND TASK.TNO = FILE.TNO AND FILE.FNO = PARTICIPATION_TASK.FNO" % uno)
